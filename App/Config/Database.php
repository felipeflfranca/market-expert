...
class Database
{
    ...
    */
    ...
    /**
    * @var string $dbUser Database access user
    */
    private string $dbUser = 'postgres';

    /**
     * @var string $dbPassword Database access password
     */
    private string $dbPassword = '100@cesso';

    /**
     * @var string $dbHost Host address
     */
    private string $dbHost = '127.0.0.1';

    /**
     * @var int $dbPort Host address
     */
